...
def make_lead_agent(config: RunnableConfig):
    ...
    profile: dict | None = cfg.get("profile")
    ...
    return create_agent(
        ...
        system_prompt=apply_prompt_template(subagent_enabled=subagent_enabled, max_concurrent_subagents=max_concurrent_subagents, agent_name=agent_name, profile=profile),
